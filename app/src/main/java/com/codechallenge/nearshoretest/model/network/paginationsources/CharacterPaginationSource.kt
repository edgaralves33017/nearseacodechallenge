...
class CharacterPaginationSource(private val apiService: ApiService, private val name: String?, private val PAGE_LIMIT: Int) :
    PagingSource<Int, MarvelChar>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MarvelChar> {
    ...
    override fun getRefreshKey(state: PagingState<Int, MarvelChar>): Int? {
